...
const TopRatedMovies = () => {
  ...
  useEffect(() => {
    axios
      .get(getTopRatedMedia("movie", "1"))
      .then((res) => setTop(res.data.results));
  }, [top]);
  useEffect(() => {
    axios
      .get(getTopRatedMedia("movie", number))
    ...
    if (select.current.options[select.current.selectedIndex].value === "1") {
      ...
      setActive(
        active
          ...
          : top.sort((a, b) => a.popularity - b.popularity)
      );
    } else if (
      ...
      setActive(
        active
          ...
          : top.sort((a, b) => a.vote_average - b.vote_average)
      );
    } else if (
      ...
      setActive(
        active
          ...
          : top.sort((a, b) => b.vote_average - a.vote_average)
      );
    } else if (
      ...
      setActive(
        active
          ...
          : top.sort((a, b) => (a.title < b.title ? -1 : 1))
      );
    } else if (
