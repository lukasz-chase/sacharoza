...
const UpcomingMovies = () => {
  ...
  useEffect(() => {
    axios
      .get(getUpcomingMedia("movie", "1"))
      .then((res) => setUpcoming(res.data.results));
  }, [upcoming]);
  useEffect(() => {
    axios
      .get(getUpcomingMedia("movie", number))
    ...
    if (select.current.options[select.current.selectedIndex].value === "1") {
      setActive(
        active
          ...
          : upcoming.sort((a, b) => b.popularity - a.popularity)
      );
    } else if (
      ...
      setActive(
        active
          ...
          : upcoming.sort((a, b) => a.popularity - b.popularity)
      );
    } else if (
      ...
      setActive(
        active
          ...
          : upcoming.sort((a, b) => a.vote_average - b.vote_average)
      );
    } else if (
      ...
      setActive(
        active
          ...
          : upcoming.sort((a, b) => b.vote_average - a.vote_average)
      );
    } else if (
      ...
      setActive(
        active
          ...
          : upcoming.sort((a, b) => (a.title < b.title ? -1 : 1))
      );
    } else if (
